...
//http://gdown.baidu.com/data/wisegame/fd84b7f6746f0b18/baiduyinyue_4802.apk
...
//        activity.registerReceiver(mDownloadReceiver,new IntentFilter(DownloadManager.ACTION_DOWNLOAD_COMPLETE));
    }
    ...
    public void downloadApk(String apkUrl, String title, String desc) {
        ...
        File apkFile = new File(weakReference.get().getExternalFilesDir(Environment.DIRECTORY_DOWNLOADS), "测试app1.1.apk");
        ...
        request.setDestinationInExternalFilesDir(weakReference.get(), Environment.DIRECTORY_DOWNLOADS, "测试app1.1.apk");
        //在手机SD卡上创建一个download文件夹
//         Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS).mkdir() ;
        //指定下载到SD卡的/download/my/目录下
//         request.setDestinationInExternalPublicDir(Environment.DIRECTORY_DOWNLOADS,"codoon_health.apk");
